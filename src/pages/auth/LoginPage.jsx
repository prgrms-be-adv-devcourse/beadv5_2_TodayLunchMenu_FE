    ...
    <div className="min-h-screen bg-fog text-plum">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 pb-12 pt-24">
        <div className="mb-12 text-center">
          <div className="mb-4 inline-flex bg-fog p-4">
            <span className="text-4xl text-plum">G</span>
          </div>
        ...
        <div className="w-full">
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <FormField label="비밀번호" htmlFor="password" error={errors.password}>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-silver transition hover:text-plum"
                  >
                    {showPassword ? "숨기기" : "보기"}
                  </button>
                </div>
                ...
                <div className="flex justify-end pt-1">
                  <Link
                    to="/forgot-password"
                    className="text-xs font-semibold text-plum transition hover:text-plum"
                  >
                    비밀번호를 잊으셨나요?
                  </Link>
                </div>
            ...
            {verificationPending ? (
              <div className="bg-fog px-4 py-4 text-sm text-plum">
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="text-xs font-semibold uppercase tracking-widest text-silver">
              또는 간편 로그인
            </span>
            <div className="h-px flex-1 bg-fog" />
          </div>
      ...
      <div className="pointer-events-none fixed right-[-5%] top-[-10%] -z-10 h-96 w-96 rounded-full bg-sand/30 blur-[100px]" />
      <div className="pointer-events-none fixed bottom-[-10%] left-[-5%] -z-10 h-96 w-96 rounded-full bg-sand/20 blur-[100px]" />
    </div>
  );
}
